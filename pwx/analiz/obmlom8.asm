 ...
 ; Buf_out_s          DB 1h,4h,0c4h,0c9h,6h,9h,2h,8h,0ach ;запрос состояния(1)
   Buf_out_s          DB 1h,4h,0c4h,0c9h,6h,8h,2h,6h,0a9h
  Buf_out_p           DB 1h,4h,0c4h,0c9h,6h,09h,0h,7h,0a9h ;запрос состояния(2)
  ...
  beg_loop:
   ...
   ;начало цикла приема сообщения
            ...
            jmp out_for_error
   nach_in:
            shl bx,1                     ;удваиваем КС заголовка
            cmp n_zaprosa,0
            jz zap_sost
